...
public class AbsoluteEncoder extends AnalogInput {
	 ...
	 * @param channel analog channel of the encoder
	 * @param angleOffset offset acquired by the getCalibration method
	 * @param flipped boolean indicating the encoder's angle needs to be reversed
	 */
	...
	/**
	 * When the encoder is pointing at the desired angle, call this method to get 
	 * the angleOffset such that the current angle will be zero.
	 * @return
	 */
