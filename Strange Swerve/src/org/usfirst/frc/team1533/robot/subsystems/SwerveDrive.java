...
public class SwerveDrive extends Subsystem {
	...
	public SwerveDrive() {
		...
		modules = new SwerveModule[] {
			...
			new SwerveModule(new Talon(Constants.Swerve.FL_DRIVE),
					...
					new AbsoluteEncoder(Constants.Swerve.FL_ENCODER, Constants.Swerve.FL_ENCODER_OFFSET, Constants.Swerve.ENCODERS_FLIPPED),
			...
			new SwerveModule(new Talon(Constants.Swerve.FR_DRIVE), 
					...
					new AbsoluteEncoder(Constants.Swerve.FR_ENCODER, Constants.Swerve.FR_ENCODER_OFFSET, Constants.Swerve.ENCODERS_FLIPPED),
					Constants.Swerve.BASE_WIDTH/2,
					Constants.Swerve.BASE_LENGTH/2
					),
			//back left
			new SwerveModule(new Talon(Constants.Swerve.BL_DRIVE),
					...
					new AbsoluteEncoder(Constants.Swerve.BL_ENCODER, Constants.Swerve.BL_ENCODER_OFFSET, Constants.Swerve.ENCODERS_FLIPPED),
					-Constants.Swerve.BASE_WIDTH/2,
					-Constants.Swerve.BASE_LENGTH/2
					),
			//back right
			new SwerveModule(new Talon(Constants.Swerve.BR_DRIVE), 
					...
					new AbsoluteEncoder(Constants.Swerve.BR_ENCODER, Constants.Swerve.BR_ENCODER_OFFSET, Constants.Swerve.ENCODERS_FLIPPED),
					Constants.Swerve.BASE_WIDTH/2,
					-Constants.Swerve.BASE_LENGTH/2
					)
		};
	...
	/**
	 * Sets the robot's center of rotation relative to the physical center of the robot.
	 * For example, if set to (0, 30), the robot will turn around the point 30 inches
	 * in front of the robot's physical center.
	 */
	...
	/**
	 * Private method to set angles and speeds of the modules. Should not be used directly.
	 ...
	 * @param headingOffset offset in heading in degrees, positive is a counter-clockwise offset
	 */
	...
	/**
	 * Points all of the modules toward the center, restricting movement of the robot.
	 */
